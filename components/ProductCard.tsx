...
const ProductCard: React.FC<ProductCardProps> = ({ product, onAddToCart }) => {
  return (
    <div className="bg-dark-card rounded-2xl overflow-hidden group transform hover:scale-105 transition-transform duration-300 shadow-lg border border-gray-700/50 flex flex-col">
      ...
      <div className="p-5 flex flex-col flex-grow">
        ...
        <button 
          onClick={onAddToCart}
          className="mt-5 w-full bg-brand-primary text-white font-semibold py-2 rounded-lg opacity-0 group-hover:opacity-100 transform translate-y-2 group-hover:translate-y-0 transition-all duration-300 hover:bg-brand-primary/90"
        >
          Add to Cart
        </button>
      </div>
